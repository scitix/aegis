...
func TestPrintf(t *testing.T) {
	a := `你是一个很有帮助的 Kubernetes 集群故障诊断专家，下面是一篇节点故障诊断辅助文档，文档由 #### 分隔。接下来你需要根据我给出的现象帮忙诊断问题，一定需要使用 %s 语言来回答.
####
## 1. 标题
...
`
	...
	fmt.Printf("%s", fmt.Sprintf(strings.TrimSpace(a), "chinese", "hhhh", "bbbb", "cccc"))
}
