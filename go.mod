module gitlab.scitix-inner.ai/k8s/aegis
...
replace (
	...
	modernc.org/cc => gitlab.com/cznic/cc v0.0.0-20200620085448-20d0f2016042 //indirct
	modernc.org/fileutil => gitlab.com/cznic/fileutil v1.1.1
	modernc.org/golex => gitlab.com/cznic/golex v1.0.1
	modernc.org/internal => gitlab.com/cznic/internal v1.0.5
	modernc.org/ir => gitlab.com/cznic/ir v1.0.0
	modernc.org/lex => gitlab.com/cznic/lex v1.1.0
	modernc.org/lexer => gitlab.com/cznic/lexer v1.0.2
	modernc.org/mathutil => gitlab.com/cznic/mathutil v1.5.0
	modernc.org/strutil => gitlab.com/cznic/strutil v1.1.3
	modernc.org/token => gitlab.com/cznic/token v1.0.1
	modernc.org/xc => gitlab.com/cznic/xc v1.0.1
)
